<template>
  <ion-page>
    <div class="w-full h-screen">
      ...
      <img class="h-full w-full object-cover" src="https://images.unsplash.com/photo-1505142468610-359e7d316be0?q=80&w=1852&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
    </div>
  </ion-page>
</template>
